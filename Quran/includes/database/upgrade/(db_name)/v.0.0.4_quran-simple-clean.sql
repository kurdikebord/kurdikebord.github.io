...
--
-- Table structure for table `temp_quran_text`
--

DROP TABLE IF EXISTS `temp_quran_text`;
CREATE TABLE `temp_quran_text` (
...
--
-- Dumping data for table `temp_quran_text`
--

-- Sura 1 (الفاتحة)
INSERT INTO `temp_quran_text` (`index`, `sura`, `aya`, `text`) VALUES
