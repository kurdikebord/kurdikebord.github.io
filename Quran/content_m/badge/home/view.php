<?php
namespace content_m\badge\home;
...
class view
{
	public static function config()
	{
		...
		\dash\data::badge_text(T_('Add new badge'));
		...
		$sortLink  = \dash\app\sort::make_sortLink(\lib\app\badge::$sort_field, \dash\url::this());
		$dataTable = \lib\app\badge::list(\dash\request::get('q'), $args);
